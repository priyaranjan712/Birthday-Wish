        ...
        <div className="space-y-32 pb-32">
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="glass-card p-12 md:p-16 text-center relative overflow-hidden border-violet-500/10 shadow-[0_0_50px_-20px_rgba(167,139,250,0.15)]">
               ...
               <h2 className="text-3xl md:text-5xl font-serif mb-8 relative text-white">To the woman who knows it all</h2>
               <p className="text-slate-300 text-lg md:text-xl mb-0 italic leading-relaxed relative font-light">
                 "I gave you space because I respect your world. I am sending this because I value your soul. 
                 Happy Birthday to the most important person in my digital and real world."
               </p>
            </div>
          </div>
